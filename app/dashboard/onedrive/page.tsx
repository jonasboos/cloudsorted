...
export default function OneDrivePage() {
  ...
  return (
    <div className="max-w-5xl">
      ...
      {!isConnected ? (
        <div className="border-4 border-black p-5 sm:p-12 bg-white text-black">
          <div className="max-w-xl">
            <div className="flex items-start sm:items-center gap-4 mb-8">
              <div className="size-14 sm:size-16 border-4 border-black flex items-center justify-center bg-black text-white shrink-0">
              ...
              <div className="min-w-0">
                ...
                <h2 className="text-2xl sm:text-3xl font-black uppercase tracking-tighter mt-2 sm:mt-1">Microsoft OneDrive</h2>
              </div>
            </div>

            <p className="font-bold uppercase text-base sm:text-lg mb-8 leading-snug">
            ...
            <Button
              ...
              className="w-full sm:w-auto bg-black text-white hover:bg-white hover:text-black border-4 border-transparent hover:border-black rounded-none h-16 px-6 sm:px-10 font-black uppercase tracking-widest text-xs sm:text-sm flex items-center gap-3"
            >
        ...
        <div className="space-y-8 sm:space-y-12">
          <div className="border-4 border-black p-5 sm:p-8 bg-white flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div className="flex items-start sm:items-center gap-4 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <h2 className="text-2xl sm:text-3xl font-black uppercase tracking-tighter mt-2 sm:mt-1 break-all">demo.user@outlook.com</h2>
              </div>
            </div>
            <Button
              onClick={disconnect}
              className="w-full sm:w-auto bg-white text-red-600 hover:bg-red-50 border-4 border-red-600 rounded-none h-14 px-8 font-black uppercase tracking-widest text-xs flex items-center gap-2"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-8">
            <div className="border-4 border-black p-5 sm:p-8 bg-white">
              <h3 className="font-black uppercase text-xl sm:text-2xl mb-6">Speicherstatus</h3>
            ...
            <div className="border-4 border-black p-5 sm:p-8 bg-white">
              <h3 className="font-black uppercase text-xl sm:text-2xl mb-6">Speicherverteilung</h3>
              <div className="h-10 border-4 border-black flex overflow-hidden mb-6">
                <div className="bg-black text-white flex items-center justify-center font-bold text-[10px] sm:text-xs uppercase" style={{ width: "12%" }}>
                  12%
                </div>
                <div className="bg-white text-black flex items-center justify-center font-bold text-[10px] sm:text-xs uppercase animate-pulse" style={{ width: "88%" }}>
                  88% Frei
                </div>
              </div>
      ...
      {connecting && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-200">
          <div className="w-full max-w-md border-4 border-black p-5 sm:p-8 bg-white relative shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] sm:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] text-center animate-in zoom-in-95 duration-200">
